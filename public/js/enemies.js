...
class BossKingCroaker extends Phaser.Physics.Arcade.Sprite {
    ...
    onGroundSlamImpact() {
        ...
        this.scene.cameras.main.shake(320, this.hp <= 2 ? 0.025 : 0.018);
        this.emitDust(14);
    ...
    takeTongueDamage(player) {
        ...
        this.scene.cameras.main.shake(isCritical ? 320 : 240, isCritical ? 0.024 : 0.018);
    ...
    takeSpitballDamage(spitball) {
        ...
        this.scene.cameras.main.shake(320, 0.025);
    ...
    takeStompDamage(player) {
        ...
        this.scene.cameras.main.shake(isCritical ? 320 : 260, 0.025);
        this.scene.events.emit('add_score', isCritical ? 2000 : 1000, this.x, this.y - 20);
        this.scene.ui.showScorePopup(
            this.x, 
            this.y - 35, 
